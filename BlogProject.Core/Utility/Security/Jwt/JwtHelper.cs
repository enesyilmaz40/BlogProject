...
namespace BlogProject.Core.Utility.Security.Jwt
{
    public class JwtHelper : ITokenHelper
    {
        ...
        private IEnumerable<Claim> SetClaims(AppUser user, IEnumerable<OperationClaim> operationClaims)
        {
        ...
        public AccessToken CreateToken(AppUser user, IEnumerable<OperationClaim> operationClaims)
        {
